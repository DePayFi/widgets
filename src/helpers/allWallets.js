...
export default [
  ...
  },
  {
    ...
    "mobile": { 
      "ios": { "native": "metamask:", "universal": "https://metamask.app.link", "qr": "WalletConnectV1", "open": ()=>`https://metamask.app.link/dapp/${window.location.toString().replace(/^(https*)*:\/\//,'').replace(/\?.*/,"")}` },
      "android": { "native": "metamask:", "universal": "https://metamask.app.link", "qr": "WalletConnectV1", "open": ()=>`https://metamask.app.link/dapp/${window.location.toString().replace(/^(https*)*:\/\//,'').replace(/\?.*/,"")}` },
    },
