                ...
                <div className='PaymentRow ChangePaymentRow' onClick={ ()=> navigate('ChangePaymentToken') }>
                  <div className='PaymentCell'>
                    <div className='PaymentCellRow1'>
                      <img className='CircularIcon' src={tokenImage}/>
