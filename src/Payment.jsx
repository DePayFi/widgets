    ...
    let unmount = mount({ style, container, document: ensureDocument(document), closed }, (unmount)=> {
      return (container)=>
        <ErrorProvider errorCallback={ error } container={ container } unmount={ unmount }>
          <ConfigurationProvider configuration={ { type: 'payment', before, amount, accept, currency, event, sent, confirmed, validated, failed, whitelist, blacklist, providers, track, fee, recover, integration, link } }>
            <UpdatableProvider>
