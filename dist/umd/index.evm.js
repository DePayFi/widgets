(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@depay/web3-wallets-evm'), require('@depay/web3-blockchains'), require('react'), require('@uiw/copy-to-clipboard'), require('@depay/react-dialog-stack'), require('qr-code-styling'), require('fuse.js'), require('@tanstack/react-virtual'), require('react-dom'), require('@depay/react-shadow-dom'), require('@depay/web3-client-evm'), require('@depay/local-currency'), require('@depay/web3-tokens-evm'), require('decimal.js'), require('ethers'), require('@depay/web3-payments-evm'), require('@depay/react-token-image-evm')) :
  typeof define === 'function' && define.amd ? define(['@depay/web3-wallets-evm', '@depay/web3-blockchains', 'react', '@uiw/copy-to-clipboard', '@depay/react-dialog-stack', 'qr-code-styling', 'fuse.js', '@tanstack/react-virtual', 'react-dom', '@depay/react-shadow-dom', '@depay/web3-client-evm', '@depay/local-currency', '@depay/web3-tokens-evm', 'decimal.js', 'ethers', '@depay/web3-payments-evm', '@depay/react-token-image-evm'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.DePayWidgets = factory(global.Web3Wallets, global.Web3Blockchains, global.React, global.copyTextToClipboard, global.ReactDialogStack, global.QRCodeStyling, global.Fuse, global.ReactVirtual, global.ReactDOM, global.ReactShadowDOM, global.Web3Client, global.LocalCurrency, global.Web3Tokens, global.Decimal, global.ethers, global.Web3Payments, global.ReactTokenImage));
}(this, (function (web3WalletsEvm, Blockchains, React, copy, reactDialogStack, QRCodeStyling, Fuse, reactVirtual, ReactDOM, reactShadowDom, web3ClientEvm, localCurrency, Token, decimal_js, ethers, web3PaymentsEvm, reactTokenImageEvm) { 'use strict';
  ...
  var allWallets = [{
    ...
    "logo": (_wallets$CoinbaseEVM = web3WalletsEvm.wallets.CoinbaseEVM) === null || _wallets$CoinbaseEVM === void 0 ? void 0 : (_wallets$CoinbaseEVM$ = _wallets$CoinbaseEVM.info) === null || _wallets$CoinbaseEVM$ === void 0 ? void 0 : _wallets$CoinbaseEVM$.logo,
    ...
    "logo": (_wallets$MetaMask = web3WalletsEvm.wallets.MetaMask) === null || _wallets$MetaMask === void 0 ? void 0 : (_wallets$MetaMask$inf = _wallets$MetaMask.info) === null || _wallets$MetaMask$inf === void 0 ? void 0 : _wallets$MetaMask$inf.logo,
    ...
    "logo": (_wallets$PhantomSVM = web3WalletsEvm.wallets.PhantomSVM) === null || _wallets$PhantomSVM === void 0 ? void 0 : (_wallets$PhantomSVM$i = _wallets$PhantomSVM.info) === null || _wallets$PhantomSVM$i === void 0 ? void 0 : _wallets$PhantomSVM$i.logo,
    "blockchains": _toConsumableArray(supported),
    "colors": {
      "primary": "#ab9ef2",
      "secondary": "#252525",
    ...
    "logo": (_wallets$TrustEVM = web3WalletsEvm.wallets.TrustEVM) === null || _wallets$TrustEVM === void 0 ? void 0 : (_wallets$TrustEVM$inf = _wallets$TrustEVM.info) === null || _wallets$TrustEVM$inf === void 0 ? void 0 : _wallets$TrustEVM$inf.logo,
    "blockchains": _toConsumableArray(supported),
    "colors": {
      "primary": "#0700ff",
      "secondary": "#48ff91",
    ...
    "logo": (_wallets$Binance = web3WalletsEvm.wallets.Binance) === null || _wallets$Binance === void 0 ? void 0 : (_wallets$Binance$info = _wallets$Binance.info) === null || _wallets$Binance$info === void 0 ? void 0 : _wallets$Binance$info.logo,
    "blockchains": _toConsumableArray(supported.evm),
    "colors": {
      "primary": "#1e2024",
      "secondary": "#f3ba2f"
    ...
    "logo": (_wallets$Coin98EVM = web3WalletsEvm.wallets.Coin98EVM) === null || _wallets$Coin98EVM === void 0 ? void 0 : (_wallets$Coin98EVM$in = _wallets$Coin98EVM.info) === null || _wallets$Coin98EVM$in === void 0 ? void 0 : _wallets$Coin98EVM$in.logo,
    "blockchains": _toConsumableArray(supported),
    "colors": {
      "primary": "#252525",
      "secondary": "#d9b432"
    ...
    "logo": (_wallets$BraveEVM = web3WalletsEvm.wallets.BraveEVM) === null || _wallets$BraveEVM === void 0 ? void 0 : (_wallets$BraveEVM$inf = _wallets$BraveEVM.info) === null || _wallets$BraveEVM$inf === void 0 ? void 0 : _wallets$BraveEVM$inf.logo,
    "blockchains": _toConsumableArray(supported),
    "colors": {
      "primary": "#ffffff",
      "secondary": "#f05a22"
    ...
    "logo": (_wallets$MagicEdenEVM = web3WalletsEvm.wallets.MagicEdenEVM) === null || _wallets$MagicEdenEVM === void 0 ? void 0 : (_wallets$MagicEdenEVM2 = _wallets$MagicEdenEVM.info) === null || _wallets$MagicEdenEVM2 === void 0 ? void 0 : _wallets$MagicEdenEVM2.logo,
    "blockchains": _toConsumableArray(supported),
    "colors": {
      "primary": "#070c34",
      "secondary": "#ff8c00"
    ...
    "logo": (_wallets$Backpack = web3WalletsEvm.wallets.Backpack) === null || _wallets$Backpack === void 0 ? void 0 : (_wallets$Backpack$inf = _wallets$Backpack.info) === null || _wallets$Backpack$inf === void 0 ? void 0 : _wallets$Backpack$inf.logo,
    ...
    "logo": (_wallets$Glow = web3WalletsEvm.wallets.Glow) === null || _wallets$Glow === void 0 ? void 0 : (_wallets$Glow$info = _wallets$Glow.info) === null || _wallets$Glow$info === void 0 ? void 0 : _wallets$Glow$info.logo,
    "blockchains": _toConsumableArray(supported.svm),
    "colors": {
      "primary": "#aa35d8",
      "secondary": "#f5e4fb"
    ...
    "logo": (_wallets$Solflare = web3WalletsEvm.wallets.Solflare) === null || _wallets$Solflare === void 0 ? void 0 : (_wallets$Solflare$inf = _wallets$Solflare.info) === null || _wallets$Solflare$inf === void 0 ? void 0 : _wallets$Solflare$inf.logo,
    "blockchains": _toConsumableArray(supported.svm),
    "colors": {
      "primary": "#fef046",
      "secondary": "#03050b"
    ...
    "logo": (_wallets$OKXEVM = web3WalletsEvm.wallets.OKXEVM) === null || _wallets$OKXEVM === void 0 ? void 0 : (_wallets$OKXEVM$info = _wallets$OKXEVM.info) === null || _wallets$OKXEVM$info === void 0 ? void 0 : _wallets$OKXEVM$info.logo,
    "blockchains": _toConsumableArray(supported.evm)
  }, {
    "name": "Mask Network",
    "desktop": {
    ...
    "logo": (_wallets$HyperPay = web3WalletsEvm.wallets.HyperPay) === null || _wallets$HyperPay === void 0 ? void 0 : (_wallets$HyperPay$inf = _wallets$HyperPay.info) === null || _wallets$HyperPay$inf === void 0 ? void 0 : _wallets$HyperPay$inf.logo,
    "blockchains": _toConsumableArray(supported.evm)
  }, {
    "name": "ATON",
    "desktop": {
    ...
    "logo": (_wallets$WindowEthere = web3WalletsEvm.wallets.WindowEthereum) === null || _wallets$WindowEthere === void 0 ? void 0 : (_wallets$WindowEthere2 = _wallets$WindowEthere.info) === null || _wallets$WindowEthere2 === void 0 ? void 0 : _wallets$WindowEthere2.logo,
    "blockchains": _toConsumableArray(supported.evm)
  }, {
    "name": "Solana Pay",
    "desktop": {
    ...
    "logo": (_wallets$WindowSolana = web3WalletsEvm.wallets.WindowSolana) === null || _wallets$WindowSolana === void 0 ? void 0 : (_wallets$WindowSolana2 = _wallets$WindowSolana.info) === null || _wallets$WindowSolana2 === void 0 ? void 0 : _wallets$WindowSolana2.logo,
    "blockchains": _toConsumableArray(supported.svm)
  }, {
    "name": "WalletConnect",
    "desktop": {
                    ...
                    return regenerator.wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            _context.next = 2;
                            return web3WalletsEvm.wallets[extension].isAvailable();
  ...
  var SelectPlatformDialog = (function (props) {
    ...
    var blockchains = props.wallet.extensions.map(function (extension) {
      return web3WalletsEvm.wallets[extension].info.blockchains;
    }).flat();
    ...
    var selectBlockchain = function selectBlockchain(blockchain) {
      props.onSelect(props.wallet.extensions.find(function (extension) {
        return web3WalletsEvm.wallets[extension].info.blockchains.includes(blockchain);
      }));
    };
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                _context.next = 9;
                return web3WalletsEvm.wallets[walletMetaData.extension].isAvailable();
  ...
  var ConnectStack = (function (props) {
    ...
    var connectExtension = function connectExtension(wallet, extension) {
      ...
      if (extension === undefined) {
        if (wallet.extensions && props.accept) {
          var availableExtensions = wallet.extensions.filter(function (availableExtension) {
            return props.accept.some(function (configuration) {
              return web3WalletsEvm.wallets[availableExtension].info.blockchains.includes(configuration.blockchain);
            });
          });
      ...
      wallet = new web3WalletsEvm.wallets[extension]();
    ...
    React.useEffect(function () {
      if ((configuration === null || configuration === void 0 ? void 0 : configuration.providers) != undefined) {
        Object.entries(props.configuration.providers).forEach(function (entry) {
          web3ClientEvm.setProviderEndpoints(entry[0], entry[1]);
        });
      }
    }, [configuration]);
    React.useEffect(function () {
  ...
  var ChangePaymentDialog = (function (props) {
    ...
    var displayedPaymentOptions = selectedPaymentOptions === null || selectedPaymentOptions === void 0 ? void 0 : selectedPaymentOptions.map(function (payment, index) {
      ...
      return /*#__PURE__*/React__default['default'].createElement("button", {
        ...
        className: "CardImage"
      }, /*#__PURE__*/React__default['default'].createElement(reactTokenImageEvm.TokenImage, {
  ...
  var SaleOverviewDialog = (function (props) {
    ...
    if (tokenImage) {
      ...
      tokenImageElement = /*#__PURE__*/React__default['default'].createElement(reactTokenImageEvm.TokenImage, {
        blockchain: payment.route.blockchain,
  ...
  var ConfirmTokenSelectionDialog = (function (props) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(Dialog$1, {
      ...
      body: /*#__PURE__*/React__default['default'].createElement("div", {
        ...
        src: logo
      }), !logo && /*#__PURE__*/React__default['default'].createElement(reactTokenImageEvm.TokenImage, {
        blockchain: token.blockchain,
        address: address
      })), /*#__PURE__*/React__default['default'].createElement("div", {
        className: "PaddingTopS TextCenter"
    ...
    if (loading) {
      ...
      elements = tokens.map(function (token, index) {
        return /*#__PURE__*/React__default['default'].createElement("div", {
          ...
          src: token.image
        }), !(token.logo || token.image) && /*#__PURE__*/React__default['default'].createElement(reactTokenImageEvm.TokenImage, {
          blockchain: token.blockchain,
          address: token.external_id || token.address
        })), /*#__PURE__*/React__default['default'].createElement("div", {
          className: "CardBody"
