...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('depay-web3-client'), require('react-dom'), require('depay-react-shadow-dom'), require('depay-react-dialog-stack'), require('depay-web3-constants'), require('ethers'), require('depay-web3-payments'), require('depay-react-token-image'), require('depay-local-currency'), require('depay-web3-exchanges'), require('depay-web3-tokens'), require('depay-web3-wallets'), require('react-rangeslider')) :
  typeof define === 'function' && define.amd ? define(['react', 'depay-web3-client', 'react-dom', 'depay-react-shadow-dom', 'depay-react-dialog-stack', 'depay-web3-constants', 'ethers', 'depay-web3-payments', 'depay-react-token-image', 'depay-local-currency', 'depay-web3-exchanges', 'depay-web3-tokens', 'depay-web3-wallets', 'react-rangeslider'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.DePayWidgets = factory(global.React, global.Web3Client, global.ReactDOM, global.ReactShadowDOM, global.ReactDialogStack, global.Web3Constants, global.ethers, global.Web3Payments, global.ReactTokenImage, global.LocalCurrency, global.Web3Exchanges, global.Web3Tokens, global.Web3Wallets, global.ReactRangeslider));
}(this, (function (React, depayWeb3Client, ReactDOM, depayReactShadowDom, depayReactDialogStack, depayWeb3Constants, ethers, depayWeb3Payments, depayReactTokenImage, depayLocalCurrency, depayWeb3Exchanges, depayWeb3Tokens, depayWeb3Wallets, Slider) { 'use strict';
  ...
  var WrongNetworkDialog = (function (props) {
    return /*#__PURE__*/React__default$1['default'].createElement(Dialog, {
      ...
      body: /*#__PURE__*/React__default$1['default'].createElement("div", {
        ...
        className: "Text FontSizeL PaddingTopS FontWeightBold"
      }, "Connect to the Ethereum network"), /*#__PURE__*/React__default$1['default'].createElement("div", {
        className: "Text PaddingTopS PaddingBottomS PaddingLeftS PaddingRightS"
      }, /*#__PURE__*/React__default$1['default'].createElement("strong", {
        className: "FontSizeM"
      }, "Make sure you connect your wallet to the correct network before you try again!"))),
      footer: /*#__PURE__*/React__default$1['default'].createElement("div", {
        className: "PaddingTopXS PaddingRightM PaddingLeftM"
      })
    });
