(function (global, factory) {
  ...
  var ConfigurationProvider = (function (props) {
    ...
    var _useState = React.useState(!((_props$configuration = props.configuration) !== null && _props$configuration !== void 0 && _props$configuration.integration) ? _objectSpread$4(_objectSpread$4({}, props.configuration), {}, {
          ...
          return regenerator.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 18:
                  setConfiguration(_objectSpread$4(_objectSpread$4(_objectSpread$4({}, _configuration), localConfigurationWithValues), {}, {
                    id: configurationId,
                    currencyCode: currencyCode
                  }));
                  _context.next = 24;
  ...
  var SignLoginDialog = (function (props) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(Dialog$1, {
      footer: /*#__PURE__*/React__default['default'].createElement("div", {
        ...
        className: "FontSizeL"
      }, "Confirm in your wallet")))), !loggingIn && /*#__PURE__*/React__default['default'].createElement("div", {
        className: "PaddingTopXS"
      }, /*#__PURE__*/React__default['default'].createElement("div", {
        ...
        className: "FontSizeL"
      }, "Click \"Log in\" and confirm"))), /*#__PURE__*/React__default['default'].createElement("button", {
        className: "ButtonPrimary",
        onClick: login
      }, "Log in")))
    });
  ...
  var CallbackContext = /*#__PURE__*/React__default['default'].createContext({
    accept: []
  });
    ...
    var updateAmounts = React.useCallback(debounce(function (_ref2) {
      ...
      getAmounts({
        ...
        setAcceptWithAmount(accept.map(function (configuration, index) {
          ...
          return _objectSpread$3(_objectSpread$3({}, configuration), {}, {
  ...
  var PaymentProvider = (function (props) {
    ...
    var _useContext2 = React.useContext(CallbackContext),
    ...
    var _useState11 = React.useState('initialized'),
        _useState12 = _slicedToArray(_useState11, 2),
        paymentState = _useState12[0],
        setPaymentState = _useState12[1];

    var _useState13 = React.useState('transaction'),
        _useState14 = _slicedToArray(_useState13, 2),
        approvalType = _useState14[0],
        setApprovalType = _useState14[1];

    var _useState15 = React.useState('max'),
        _useState16 = _slicedToArray(_useState15, 2),
  ...
  var PaymentFailedDialog = (function () {
    ...
    return /*#__PURE__*/React__default['default'].createElement(Dialog$1, {
      ...
      body: /*#__PURE__*/React__default['default'].createElement("div", {
        ...
        className: "FontSizeM"
      }, "Your payment did not succeed.")), /*#__PURE__*/React__default['default'].createElement("div", {
        className: "PaddingTopXS"
      }, /*#__PURE__*/React__default['default'].createElement("strong", {
        className: "FontSizeM"
      }, "Please try again.")), /*#__PURE__*/React__default['default'].createElement("div", {
        className: "PaddingTopS"
      }, transaction && /*#__PURE__*/React__default['default'].createElement("a", {
        className: "Link",
  ...
  var SolanaPayDialog = (function (props) {
    ...
    var currentDeadline = React.useRef();
    ...
    var openTransactionTrackingSocket = function openTransactionTrackingSocket(_ref) {
      ...
      transactionTrackingSocket.current = openManagedSocket({
        ...
        endpoints: Blockchains__default['default'].solana.sockets.reverse(),
        onopen: function onopen() {
          return {
            "jsonrpc": "2.0",
            "id": id,
    ...
    if (state === 'tracingFailed') {
      return /*#__PURE__*/React__default['default'].createElement(TracingFailedDialog, {
    ...
    if (state === 'initializing') {
      ...
      return /*#__PURE__*/React__default['default'].createElement(Dialog$1, {
        ...
        body: /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement("div", {
          ...
          ref: QRCodeElement,
          className: "QRCode"
        }), ['pay', 'succeeded'].includes(state) && /*#__PURE__*/React__default['default'].createElement("div", {
          className: "PaddingTopXS"
        ...
        footer: /*#__PURE__*/React__default['default'].createElement("div", {
          ...
          className: "StepText"
        }, "Payment confirmed")))), (release || !synchronousTracking) && forwardTo && /*#__PURE__*/React__default['default'].createElement("div", {
          className: "PaddingBottomXS"
        }, /*#__PURE__*/React__default['default'].createElement("a", {
          className: "ButtonPrimary",
          href: forwardTo,
  ...
  var ValidationFailedDialog = (function () {
    ...
    return /*#__PURE__*/React__default['default'].createElement(Dialog$1, {
      ...
      body: /*#__PURE__*/React__default['default'].createElement("div", {
        ...
        className: "LineHeightL Text FontSizeL PaddingTopS FontWeightBold"
      }, "Validation failed"), /*#__PURE__*/React__default['default'].createElement("div", {
        className: "Text PaddingBottomS PaddingLeftS PaddingRightS"
      }, /*#__PURE__*/React__default['default'].createElement("div", {
        className: "PaddingTopS"
      }, /*#__PURE__*/React__default['default'].createElement("strong", {
        className: "FontSizeM"
      }, "Confirming the payment failed.")), /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  var PaymentStack = (function (props) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(reactDialogStack.ReactDialogStack, {
      ...
      dialogs: {
        ...
        ValidationFailed: /*#__PURE__*/React__default['default'].createElement(ValidationFailedDialog, null)
      }
    });
  });
  ...
  var PaymentTrackingProvider = (function (props) {
    ...
    var _useContext3 = React.useContext(CallbackContext),
