...
var RoutingContext = /*#__PURE__*/React__default['default'].createContext();
...
var ChangePaymentSkeleton = (function (props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(Dialog, {
    ...
    }, "Change Payment"), /*#__PURE__*/React__default['default'].createElement("div", {
      className: "FontSizeL TextCenter FontWeightBold"
    }, /*#__PURE__*/React__default['default'].createElement("strong", null, localValue.toString()))),
  ...
  React.useEffect(function () {
    setCards(allPaymentRoutesWithData.map(function (payment, index) {
      return /*#__PURE__*/React__default['default'].createElement("div", {
        ...
        className: "CardInfo"
      }, payment.route.directTransfer && /*#__PURE__*/React__default['default'].createElement("span", {
        className: "Label"
      }, "Lowest Network Fee"), payment.route.approvalRequired && /*#__PURE__*/React__default['default'].createElement("span", {
        className: "Label"
      }, "Requires Approval")));
    }));
...
var QuestionsGraphic = "data:image/png;base64,";
...
var UpdateContext = /*#__PURE__*/React__default['default'].createContext();
...
var PaymentOverviewDialog = (function (props) {
  ...
  var actions = function actions() {
    return /*#__PURE__*/React__default['default'].createElement("div", null, payment.route.approvalRequired && !payment.route.directTransfer && approvalAction(), mainAction());
  };

  React.useEffect(function () {
    if (allRoutes && allRoutes.length == 0) {
      set(['NoPaymentMethodFound']); // setUpdate(false)
    }
  }, [allRoutes]);
...
var PaymentStack = (function (props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(depayReactDialogStack.ReactDialogStack, {
    open: open,
    close: close,
...
var ToTokenProvider = (function (props) {
  ...
  var getToTokenLocalValue = function getToTokenLocalValue(_ref) {
    ...
    Promise.all([depayWeb3Exchanges.route({
      blockchain: blockchain,
      tokenIn: token,
      tokenOut: depayWeb3Constants.CONSTANTS[blockchain].USD,
      amountIn: amount,
      fromAddress: account,
      toAddress: account
    }), new depayWeb3Tokens.Token({
      blockchain: blockchain,
      address: depayWeb3Constants.CONSTANTS[blockchain].USD
...
var UpdateProvider = (function (props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(UpdateContext.Provider, {
    value: {
      update: update,
      setUpdate: setUpdate
    }
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            content = function content(container) {
              ...
              }, /*#__PURE__*/React__default['default'].createElement(ClosableProvider, {
                unmount: unmountShadowDOM
              }, /*#__PURE__*/React__default['default'].createElement(UpdateProvider, null, /*#__PURE__*/React__default['default'].createElement(WalletProvider, null, /*#__PURE__*/React__default['default'].createElement(ToTokenProvider, null, /*#__PURE__*/React__default['default'].createElement(RoutingProvider, null, /*#__PURE__*/React__default['default'].createElement(PaymentProvider, null, /*#__PURE__*/React__default['default'].createElement(PaymentStack, {
                document: document,
                container: container
              }))))))));
            };

            _ReactShadowDOM = depayReactShadowDom.ReactShadowDOM({
              document: document,
