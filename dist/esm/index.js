...
var ErrorProvider = (function (props) {
  ...
  var errorsDisabledRef = useRef(errorsDisabled);
  useEffect(function () {
...
var ConfigurationProvider = (function (props) {
  ...
  var _useState = useState(!((_props$configuration = props.configuration) !== null && _props$configuration !== void 0 && _props$configuration.integration) ? _objectSpread$4(_objectSpread$4({}, props.configuration), {}, {
...
var PaymentProvider = (function (props) {
  ...
  var _useContext7 = useContext(ErrorContext),
      setErrorsDisabled = _useContext7.setErrorsDisabled;

  var _useContext8 = useContext(UpdatableContext),
      setUpdatable = _useContext8.setUpdatable;

  var _useContext9 = useContext(NavigateContext),
      navigate = _useContext9.navigate,
      set = _useContext9.set;

  var _useContext10 = useContext(WalletContext),
      wallet = _useContext10.wallet,
      account = _useContext10.account;

  var _useContext11 = useContext(PaymentTrackingContext),
  ...
  var allowancePolling = useRef();
  var approvalConfirmed = useRef();
...
var Footer = (function () {
  ...
  var steps = function steps() {
    if (paymentState == 'initialized' && approvalTransaction !== null && approvalTransaction !== void 0 && approvalTransaction.url || paymentState == 'approve' || paymentState == 'approving' || paymentState == 'approved' || paymentState == 'paying' && (approvalTransaction !== null && approvalTransaction !== void 0 && approvalTransaction.url || approvalSignature) || paymentState == 'sending' || paymentState == 'validating' || paymentState == 'success') {
      ...
      return /*#__PURE__*/React.createElement("div", {
      ...
      }, (needsPermit2Transaction || permit2Done) && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("a", {
        ...
        className: "StepText"
      }, "Payment confirmed")), showContactSupport && paymentState == 'validating' && /*#__PURE__*/React.createElement("div", {
        className: "Step Card small transparent disabled active"
      }, /*#__PURE__*/React.createElement("div", {
        className: "StepIcon"
      }), /*#__PURE__*/React.createElement("div", {
        className: "StepText"
      }, /*#__PURE__*/React.createElement("span", null, "Need help?\xA0"), /*#__PURE__*/React.createElement("a", {
        href: link({
    ...
    if (updatedRouteWithNewPrice) {
      ...
      if (approvalRequired) {
        if (paymentState == 'initialized' || paymentState == 'approve' && approvalTransaction !== null && approvalTransaction !== void 0 && approvalTransaction.url) {
          ...
          }, !(approvalTransaction !== null && approvalTransaction !== void 0 && approvalTransaction.url) && !approvalSignature && /*#__PURE__*/React.createElement("div", {
...
var SolanaPayDialog = (function (props) {
  ...
  var _useContext6 = useContext(WalletContext),
      solanaPayWallet = _useContext6.solanaPayWallet,
      setAccount = _useContext6.setAccount;

  var _useContext7 = useContext(PaymentTrackingContext),
  ...
  var _useContext8 = useContext(PaymentRoutingContext),
      setSelectedRoute = _useContext8.setSelectedRoute;

  var _useContext9 = useContext(PaymentValueContext),
...
var PaymentTrackingProvider = (function (props) {
  ...
  var _useContext6 = useContext(ErrorContext),
