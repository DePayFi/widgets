...
var ErrorProvider = (function (props) {
  ...
  if (error) {
    ...
    }, /*#__PURE__*/React.createElement(ErrorGraphic$1, null)), /*#__PURE__*/React.createElement("h1", {
...
var SolanaPayContext = /*#__PURE__*/React.createContext();
...
var WalletProvider = (function (props) {
  ...
  var _useState11 = useState(passedWallet ? 'connected' : undefined),
      _useState12 = _slicedToArray(_useState11, 2),
...
var Footer = (function () {
  ...
  var _useState3 = useState('transaction'),
      _useState4 = _slicedToArray(_useState3, 2);
      _useState4[0];
      _useState4[1];
  ...
  var steps = function steps() {
    if (paymentState == 'approve' || paymentState == 'approving' || paymentState == 'approved' || paymentState == 'paying' || paymentState == 'sending' || paymentState == 'success') {
      ...
      return /*#__PURE__*/React.createElement("div", {
      ...
      }, paymentState == 'approve' && /*#__PURE__*/React.createElement("div", {
      ...
      })), approvalTransaction && /*#__PURE__*/React.createElement("a", {
        ...
        className: "small"
      }), paymentState == 'approving' && /*#__PURE__*/React.createElement("div", {
        className: "ActionIndicatorSpinner"
      })), /*#__PURE__*/React.createElement("div", {
        className: "StepText"
      }, paymentState == 'approving' && /*#__PURE__*/React.createElement(LoadingText, null, "Approving"), paymentState != 'approving' && /*#__PURE__*/React.createElement("span", null, "Approve spending ", payment.symbol)), paymentState == 'approving' && /*#__PURE__*/React.createElement("div", {
        className: "StepConnector"
      })), approvalSignature && /*#__PURE__*/React.createElement("div", {
        ...
        className: "StepConnector"
      })), !transaction && paymentState != 'sending' && /*#__PURE__*/React.createElement("div", {
        ...
        className: "small"
      }), (paymentState == 'paying' || paymentState == 'sending') && /*#__PURE__*/React.createElement("div", {
        className: "ActionIndicatorSpinner"
      })), /*#__PURE__*/React.createElement("div", {
        className: "StepText"
      }, (paymentState == 'paying' || paymentState == 'sending') && /*#__PURE__*/React.createElement(LoadingText, null, "Performing payment"), paymentState == 'success' && /*#__PURE__*/React.createElement("span", null, "Perform payment")), /*#__PURE__*/React.createElement("div", {
        className: "StepConnector"
      })), asynchronousTracking && trackingInitialized == false && /*#__PURE__*/React.createElement("div", {
        className: "Step active Card disabled small transparent"
      }, /*#__PURE__*/React.createElement("div", {
        className: "StepIcon"
      }, /*#__PURE__*/React.createElement("div", {
        ...
        className: "StepConnector"
      })), synchronousTracking && !release && /*#__PURE__*/React.createElement("a", {
        href: transaction ? link({
        ...
        className: "StepText"
      }, paymentState != 'validating' && /*#__PURE__*/React.createElement("span", null, "Wait for payment confirmation"), paymentState == 'validating' && /*#__PURE__*/React.createElement(LoadingText, null, "Confirming payment"), transaction && confirmationsRequired && secondsLeft > 0 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", null, "Confirming payment"), /*#__PURE__*/React.createElement("span", {
        title: "".concat(confirmationsPassed, "/").concat(confirmationsRequired, " required confirmations")
      }, " ", secondsLeft, "s")))), synchronousTracking && release && /*#__PURE__*/React.createElement("a", {
        href: transaction ? link({
          url: "https://status.depay.com/tx/".concat(transaction.blockchain, "/").concat(transaction.id),
          target: '_blank',
          wallet: wallet
...
var SolanaPayStack = (function (props) {
  ...
  return /*#__PURE__*/React.createElement(ReactDialogStack, {
    ...
    stacked: true,
    dialogs: {
      SolanaPay: /*#__PURE__*/React.createElement(SolanaPayDialog, {
        unmount: props.unmount,
        document: props.document
      })
    }
...
var SolanaPayProvider = (function (props) {
  ...
  if (showSolanaPayStack) {
    return /*#__PURE__*/React.createElement(SolanaPayStack, {
    ...
    return /*#__PURE__*/React.createElement(SolanaPayContext.Provider, {
      value: {
        start: start
      }
    }, props.children);
