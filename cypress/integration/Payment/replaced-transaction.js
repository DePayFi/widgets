...
import { mock, confirm, fail, increaseBlock, resetMocks } from '@depay/web3-mock'
...
describe('detects replaced Payment transaction', () => {
  ...
  it('detects replaced transaction via ethersjs transaction error code=TRANSACTION_REPLACED', () => {
